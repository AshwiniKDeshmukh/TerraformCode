...
resource "aws_iam_instance_profile" "ec2_ssm_profile1" {
  name = "ec2_ssm_profile1"
  role = aws_iam_role.ec2_ssm_role1.name
}
...
resource "aws_instance" "ec2_instance" {
  ...
  iam_instance_profile   = var.subnet_type == "private" ? aws_iam_instance_profile.ec2_ssm_profile1.name : null
